...
namespace PaintDotNet.Data.PhotoshopFileType
{
    internal static class PsdLoad
    {
        ...
        public static Document Load(System.IO.Stream input)
        {
            ...
            // test2
            var guidesInfo = (GridGuidesInfo)psdFile.ImageResources.Get(ResourceID.GridGuidesInfo);
            // Convert into Paint.NET internal representation
            var document = new Document(psdFile.ColumnCount, psdFile.RowCount, guidesInfo.Guides);
