...
namespace UnityEditor.U2D.PSD
{
    ...
    public class PSDImporterEditor : ScriptedImporterEditor, ITexturePlatformSettingsDataProvider
    {
        ...
        // test2
        SerializedProperty m_spriteNameInvert;
        ...
        public override void OnEnable()
        {
            base.OnEnable();
            // test2
            m_spriteNameInvert = serializedObject.FindProperty("m_SpriteNameInvert");
        ...
        void DoSettingsUI()
        {
            ...
            // test2
            if (m_EditorFoldOutState.DoTools(styles.toolsHeaderText))
            {
                EditorGUILayout.PropertyField(m_spriteNameInvert, styles.spriteNameInvert);
            }
        ...
        internal class Styles
        {
            ...
            // test2
            public readonly GUIContent toolsHeaderText  = EditorGUIUtility.TrTextContent("Tools", "工具");
            public readonly GUIContent spriteNameInvert = EditorGUIUtility.TrTextContent("Sprite Name Invert", "调转sprite排序");
    ...
    class PSDImporterEditorFoldOutState
    {
        ...
        public PSDImporterEditorFoldOutState()
        {
            ...
            m_ToolsFoldout = new SavedBool("PSDImporterEditor.m_ToolsFoldout", true);
        ...
        public bool DoTools(GUIContent title)
        {
            m_ToolsFoldout.value = DoFoldout(title, m_ToolsFoldout.value);
            return m_ToolsFoldout.value;
        }
